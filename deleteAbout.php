...
<form class="shake" role="form" action="deleteAbout.php" method="POST" data-toggle="validator">

<div class="form-group label-floating">
<label class="control-label" for="id">About Id</label>
<input class="form-control" id="id" placeholder= "Enter About ID" type="text" name="id" required data-error="Please enter id">
...
if(isset($_POST['delete']))
{
    ...
    mysqli_close($con);
    echo "<script>window.location='deleteAbout.php';</script>";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
     ...
     //   echo '<img src="data:image/jpeg;base64,'.base64_encode( $image).'"/>';
        echo "<tr><td>" . $row["id"] . "</td><td>" . $row["question"] . "</td><td>" . $row["paragraph"] . "</td><td><img src='data:image/jpeg;base64," .base64_encode( $image). "'/></td></tr>";
    }
    echo "</table>";
} else {
