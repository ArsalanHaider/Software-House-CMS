...
<form class="shake" role="form" action="deleteservice.php" method="POST" data-toggle="validator">
...
if(isset($_POST['delete']))
{
    ...
    mysqli_close($con);
    echo "<script>window.location='deleteservice.php';</script>";
                                        ...
                                        <tbody>
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    echo "<tr><td>" . $row["id"] . "</td><td>" . $row["icon"] . "</td><td>" . $row["title"] . "</td><td>" . $row["descriptions"] . "</td></tr>";
                                                }
                                                echo "</table>";
                                            } else {
