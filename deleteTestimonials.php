...
<form class="shake" role="form" action="deleteTestimonials.php" method="POST" data-toggle="validator">

<div class="form-group label-floating">
<label class="control-label" for="id">Testimonial Id</label>
<input class="form-control" id="id" placeholder= "Enter Testimonial ID" type="text" name="id" required data-error="Please enter id">
...
if(isset($_POST['delete']))
{
    ...
    mysqli_close($con);
    echo "<script>window.location='deleteTestimonials.php';</script>";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
     ...
     //   echo '<img src="data:image/jpeg;base64,'.base64_encode( $image).'"/>';
        echo "<tr><td>" . $row["id"] . "</td><td>" . $row["names"] . "</td><td>" . $row["company"] . "</td><td>" . $row["testimonial"] . "</td><td><img src='data:image/jpeg;base64," .base64_encode( $image). "'/></td></tr>";
    }
    echo "</table>";
} else {
