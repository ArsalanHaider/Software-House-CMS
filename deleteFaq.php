...
<form class="shake" role="form" action="deleteFaq.php" method="POST" data-toggle="validator">

<div class="form-group label-floating">
<label class="control-label" for="id">FAQ Id</label>
...
<button class="btn btn-primary" onclick()="return msg();" type="submit" name="delete" id="delete"><i class="material-icons mdi mdi-message-outline"></i>Delete Faq</button>
...
if(isset($_POST['delete']))
{
    ...
    mysqli_close($con);
    echo "<script>window.location='deleteFaq.php';</script>";
                                        ...
                                        <tbody>
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    echo "<tr><td>" . $row["id"] . "</td><td>" . $row["question"] . "</td><td>" . $row["answer"] . "</td></tr>";
                                                }
                                                echo "</table>";
                                            } else {
