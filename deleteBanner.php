...
<form class="shake" role="form" action="deleteBanner.php" method="POST" data-toggle="validator">

<div class="form-group label-floating">
<label class="control-label" for="id">Banner Id</label>
<input class="form-control" id="id" type="text" name="id" required data-error="Please enter Banner Id">
...
if(isset($_POST['delete']))
{
    ...
    mysqli_close($con);
    echo "<script>window.location='deleteBanner.php';</script>";
                               ...
                               <div class="table-stats order-table ov-h " style="text-align:center;">
                                    <table class="table ">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT id, heading,subtitle FROM banner";
                                            $result = $con->query($sql);
                                            if ($result->num_rows > 0) {
                                                // output data of each row'
                                                while ($row = $result->fetch_assoc()) {
                                                 echo "<tr><td>" . $row["id"] . "</td><td>" . $row["heading"] . "</td><td>" . $row["subtitle"] ."</td></tr>";
                                                }
                                                echo "</table>";
                                            } else {
