...
<form class="shake" role="form" action="deleteBrands.php" method="POST" data-toggle="validator">

<div class="form-group label-floating">
<label class="control-label" for="id">Logo Id</label>
<input class="form-control" id="id" type="text" name="id" required data-error="Please enter Logo Id">
...
if(isset($_POST['delete']))
{
    ...
    // mysql delete query 
    $query = "DELETE FROM `brandslogo` WHERE `id` = $id";
    ...
    mysqli_close($con);
    echo "<script>window.location='deleteBrands.php';</script>";
                               ...
                               <div class="table-stats order-table ov-h " style="text-align:center;">
                                    <table class="table ">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT id, brandName,images  FROM brandslogo";
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                 ...
                                                 //   echo '<img src="data:image/jpeg;base64,'.base64_encode( $image).'"/>';
                                                    echo "<tr><td>" . $row["id"] . "</td><td>" . $row["brandName"] . "</td><td><img src='data:image/jpeg;base64," .base64_encode( $image). "'/></td></tr>";
                                                }
                                                echo "</table>";
                                            } else {
